...
class TurnoTestCase(TestCase):
    def setUp(self):
        self.cliente = Cliente.objects.create(nombre="Cliente1", apellido="Apellido1", dni=12345678, telefono=123456789, mail="cliente1@example.com")
        self.profesional = Profesional.objects.create(nombre="Profesional1", apellido="Apellido2", dni=87654321, telefono=987654321, mail="profesional1@example.com")
    ...
    def test_cliente_reserva_turno(self):
        cliente2 = Cliente.objects.create(nombre="Cliente2", apellido="Apellido3", dni=11223344, telefono=987654321, mail="cliente2@example.com")
